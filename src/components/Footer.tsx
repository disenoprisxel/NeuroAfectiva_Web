...
export default function Footer() {
  return (
    <footer className="bg-[#182038] text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a href="https://www.instagram.com/neuroafectiva/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-9 h-9 rounded-full bg-white/10 hover:bg-[#7C4EC8] flex items-center justify-center transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li className="flex gap-2">
                ...
                <span>Próximamente en Bogotá<br /><span className="text-[#FF4DA6] font-semibold">Atención 100% virtual</span></span>
              </li>
              <li className="flex gap-2">
                <span>📞</span>

...
export default function Footer() {
  return (
    <footer className="bg-[#0E234F] text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a href="https://www.instagram.com/neuroafectiva/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-9 h-9 rounded-full bg-white/10 hover:bg-[#8537D8] flex items-center justify-center transition-colors">

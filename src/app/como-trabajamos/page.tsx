...
const pasos = [
  ...
  },
  {
    ...
    img: 'https://images.unsplash.com/photo-1503676260728-1c00da094a0b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080',
    sectionBg: 'bg-white',
    reverse: false,
  },
  {
    ...
    featureColor: 'text-[#fc66b5] bg-[#FFF0F9]',
    img: 'https://images.unsplash.com/photo-1576091160550-2173dba999ef?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080',
    sectionBg: 'bg-[#F8F4FF]',
    reverse: true,
  },
  {
    ...
    featureColor: 'text-[#713ec1] bg-[#F0EAFB]',
    img: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080',
    sectionBg: 'bg-white',
    reverse: false,
  },
  {
    ...
    featureColor: 'text-[#32b8cc] bg-[#E8F9FD]',
    img: 'https://images.unsplash.com/photo-1551836022-deb4988cc6c0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080',
    sectionBg: 'bg-[#F8F4FF]',
    reverse: true,
  },
]

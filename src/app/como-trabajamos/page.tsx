...
const pasos = [
  ...
  },
  {
    ...
    featureColor: 'text-[#fc66b5] bg-[#FFF0F9]',
    img: 'https://images.unsplash.com/photo-mBG8X1nCtK4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080',
    sectionBg: 'bg-[#F8F4FF]',
    reverse: true,
  },
  {
  ...
  },
  {
    ...
    featureColor: 'text-[#32b8cc] bg-[#E8F9FD]',
    img: 'https://images.unsplash.com/photo-YucgPlBUEQw?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080',
    sectionBg: 'bg-[#F8F4FF]',
    reverse: true,
  },
]

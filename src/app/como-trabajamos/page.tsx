...
const pasos = [
  ...
  },
  {
    ...
    featureColor: 'text-[#fc66b5] bg-[#FFF0F9]',
    img: 'https://images.unsplash.com/photo-1590650046871-92c887180603?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080',
    sectionBg: 'bg-[#F8F4FF]',
    reverse: true,
  },
  {
    ...
    featureColor: 'text-[#713ec1] bg-[#F0EAFB]',
    img: 'https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080',
    sectionBg: 'bg-white',
    reverse: false,
  },
  {

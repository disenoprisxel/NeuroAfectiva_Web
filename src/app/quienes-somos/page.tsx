    ...
    <section className="bg-white py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex items-center gap-2 text-xs text-gray-400 mb-10">
          <Link href="/" className="hover:text-[#8537D8] transition-colors">Inicio</Link>
          <span>/</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link
                href="/servicios"
                className="text-[#8537D8] hover:text-[#7530C5] font-bold text-sm flex items-center gap-1.5 transition-colors"
              >
                Ver servicios
            ...
            <ul className="space-y-2 text-sm text-gray-500">
              {['Empatía y calidad humana', 'Rigor científico y ético', 'Inclusión y diversidad', 'Innovación constante'].map((v) => (
                <li key={v} className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#8537D8] flex-shrink-0" />
                  {v}
                </li>
              ))}
            </ul>
...
function StatsDark() {
  ...
  return (
    <section className="bg-[#162845] py-10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <ul className="space-y-3 mb-8">
              {[
                ...
                <li key={item} className="flex items-start gap-3 text-sm text-gray-600">
                  <span className="w-5 h-5 rounded-full bg-[#EDE5FF] flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-[#8537D8]" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
            ...
            <Link
              href="/equipo"
              className="bg-[#8537D8] hover:bg-[#7530C5] text-white font-bold px-7 py-3 rounded-full transition-colors shadow-md text-sm inline-block"
            >
              Conoce el equipo
            </Link>
          </div>

  ...
  return (
    <section className="bg-white py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Breadcrumb */}
        <nav data-animate className="flex items-center gap-2 text-xs text-gray-400 mb-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Left — image */}
          <div data-animate="left" className="relative order-2 lg:order-1 na-img-zoom overflow-hidden rounded-3xl">
          ...
          <div className="order-1 lg:order-2">
            <span data-animate="right" data-delay="1" className="na-badge inline-block bg-[#F0EAFB] text-[#713ec1] text-xs font-bold px-4 py-1.5 rounded-full mb-5 tracking-wide">
              Nuestra misión
            </span>
            <h1 data-animate="right" data-delay="2" className="text-4xl sm:text-5xl font-extrabold text-gray-900 mb-6">
              Somos NeuroAfectiva
            </h1>
            <p data-animate="right" data-delay="3" className="text-gray-500 text-base leading-relaxed mb-4">
            ...
            <p data-animate="right" data-delay="4" className="text-gray-500 text-base leading-relaxed mb-8">
            ...
            <div data-animate="right" data-delay="5" className="flex flex-wrap gap-3">
              <Link
                href="/equipo"
                className="na-btn na-btn-gradient bg-[#713ec1] text-white font-bold px-7 py-3 rounded-full shadow-md text-sm"
              ...
              <Link
                href="/servicios"
                className="na-btn text-[#713ec1] font-bold text-sm flex items-center gap-1.5 border-2 border-[#713ec1] px-6 py-3 rounded-full"
              >
                Ver servicios
    ...
    <section className="bg-[#F8F4FF] py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <span data-animate className="text-xs font-bold tracking-widest text-[#713ec1] uppercase">Nuestra Propuesta</span>
          <h2 data-animate data-delay="1" className="mt-2 text-3xl sm:text-4xl font-extrabold text-gray-900">Lo que nos mueve cada día</h2>
          <p data-animate data-delay="2" className="mt-3 text-gray-500 text-sm max-w-xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Misión */}
          <div data-animate data-delay="1" className="na-card bg-white rounded-2xl p-8 shadow-lg">
          ...
          {/* Visión */}
          <div data-animate data-delay="2" className="na-card bg-white rounded-2xl p-8 shadow-lg">
          ...
          {/* Valores */}
          <div data-animate data-delay="3" className="na-card bg-white rounded-2xl p-8 shadow-lg">
        ...
        <div className="grid grid-cols-3 gap-4 text-center">
          {stats.map((s, i) => (
            <div
              ...
              className={`na-stat ${i < stats.length - 1 ? 'border-r border-white/10' : ''} px-4`}
            >
              <div className={`na-stat-value text-2xl sm:text-3xl font-extrabold mb-1 ${s.highlight ? 'text-[#fc66b5]' : 'text-white'}`}>
                {s.value}
              </div>
    ...
    <section className="bg-white py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Left — copy */}
          <div>
            <span data-animate className="text-xs font-bold tracking-widest text-[#713ec1] uppercase mb-4 block">Nuestro Equipo</span>
            <h2 data-animate data-delay="1" className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-5">
              Especialistas apasionados<br />por la neurociencia
            </h2>
            <p data-animate data-delay="2" className="text-gray-500 text-sm leading-relaxed mb-7">
            ...
            <ul className="space-y-3 mb-8">
              {[
                ...
                <li key={item} data-animate data-delay={String(i + 3)} className="flex items-start gap-3 text-sm text-gray-600">
            ...
            <div data-animate data-delay="6">
              <Link
                href="/equipo"
                className="na-btn na-btn-gradient text-white font-bold px-7 py-3 rounded-full shadow-md text-sm inline-block"
                style={{ background: 'linear-gradient(90deg, #713ec1 0%, #fc66b5 100%)' }}
              >
                Conoce el equipo
              </Link>
          ...
          <div className="space-y-4">
            {especialistas.map((e, i) => (
              <div
                ...
                data-animate="right"
                data-delay={String(i + 1)}
                className="na-card bg-white border border-gray-100 rounded-2xl p-5 shadow-sm flex items-center gap-5"
              >
                ...
                <span className={`na-badge text-xs font-bold px-3 py-1 rounded-full flex-shrink-0 ${e.badge.color}`}>
                  {e.badge.label}
                </span>
              </div>
            ))}
  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
        <span data-animate className="text-xs font-bold tracking-widest text-white/70 uppercase mb-4 block">¿Lista para empezar?</span>
        <h2 data-animate data-delay="1" className="text-3xl sm:text-4xl font-extrabold mb-4">Tu bienestar neurológico comienza aquí</h2>
        <p data-animate data-delay="2" className="text-white/80 text-base mb-8 max-w-xl mx-auto">
          Agenda tu primera consulta y descubre cómo podemos transformar tu vida.
        </p>
        <div data-animate data-delay="3" className="flex flex-wrap justify-center gap-4">
          <Link
            href="/agendar"
            className="na-btn bg-white text-[#713ec1] hover:bg-gray-50 font-bold px-8 py-3 rounded-full shadow-lg text-sm"
          >
            Agendar consulta
          </Link>
          <Link
            href="/servicios"
            className="na-btn border-2 border-white/60 hover:border-white text-white font-bold px-8 py-3 rounded-full text-sm"
          >
            Conocer servicios
          </Link>
        </div>
  ...
  return (
    <section className="bg-[#F8F4FF] py-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 data-animate className="text-2xl sm:text-3xl font-extrabold text-gray-900 text-center mb-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {impacto.map((item, i) => (
            <div
              ...
              data-animate="scale"
              data-delay={String(i + 1)}
              className="na-card bg-white rounded-2xl p-6 text-center shadow-sm"
            >

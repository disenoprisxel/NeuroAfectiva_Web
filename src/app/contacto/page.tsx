            ...
            <div data-animate="right" className="lg:col-span-2">
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <a href="https://www.instagram.com/cognyvita/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-10 h-10 rounded-full bg-gradient-to-br from-[#8537D8] to-[#F545B4] flex items-center justify-center hover:opacity-90 transition-opacity">

  ...
  if (sent) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center">
        <div className="w-16 h-16 rounded-full bg-[#EDE5FF] flex items-center justify-center mb-5">
          <svg className="w-8 h-8 text-[#8537D8]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label className="block text-xs font-bold text-gray-700 mb-1.5">
            Nombre completo <span className="text-[#F545B4]">*</span>
          </label>
          <input
            type="text"
            name="nombre"
            ...
            className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#8537D8] focus:border-transparent transition"
          />
        </div>
        <div>
          <label className="block text-xs font-bold text-gray-700 mb-1.5">
            Correo electrónico <span className="text-[#F545B4]">*</span>
          </label>
          <input
            type="email"
            name="email"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label className="block text-xs font-bold text-gray-700 mb-1.5">
            Teléfono / WhatsApp <span className="text-[#F545B4]">*</span>
          </label>
          <input
            type="tel"
            name="telefono"
        ...
        <div>
          ...
          <select
            ...
            value={form.servicio}
            onChange={handleChange}
            className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#8537D8] focus:border-transparent transition bg-white appearance-none"
          >
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#8537D8] focus:border-transparent transition resize-none"
        />
      </div>
      ...
      <label className="flex items-start gap-3 cursor-pointer">
        <div className="relative mt-0.5">
          ...
          />
          <div className="w-5 h-5 border-2 border-gray-300 rounded-md peer-checked:bg-[#8537D8] peer-checked:border-[#8537D8] transition-colors flex items-center justify-center">
            {form.politica && (
        ...
        <span className="text-xs text-gray-500 leading-relaxed">
          Acepto la{' '}
          <Link href="/privacidad" className="text-[#8537D8] underline">
      ...
      <button
        type="submit"
        disabled={sending}
        className="w-full bg-gradient-to-r from-[#8537D8] to-[#F545B4] hover:from-[#7530C5] hover:to-[#DC3AA8] text-white font-bold py-4 rounded-full transition-all shadow-lg text-sm flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
      >
        {sending ? (
          <>
    ...
    <>
      ...
      <section className="bg-[#F6F2FF] py-14 lg:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span data-animate className="na-badge inline-block bg-[#FFF0F9] text-[#F545B4] text-xs font-bold px-4 py-1.5 rounded-full mb-5 tracking-widest uppercase">
            Contáctanos
          </span>
            ...
            <div data-animate="right" className="lg:col-span-2">
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <a href="https://www.instagram.com/neuroafectiva/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-10 h-10 rounded-full bg-gradient-to-br from-[#8537D8] to-[#F545B4] flex items-center justify-center hover:opacity-90 transition-opacity">
      ...
      {/* Footer dark bar */}
      <section className="bg-[#0E234F] py-6">

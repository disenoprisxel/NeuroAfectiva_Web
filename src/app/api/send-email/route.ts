    ...
    if (type === 'contacto') {
      ...
      html = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background: #f9f6ff; border-radius: 12px;">
          <h2 style="color: #8537D8; margin-bottom: 4px;">Nuevo mensaje de contacto</h2>
          ...
          <table style="width: 100%; border-collapse: collapse; font-size: 14px; color: #333;">
            ...
            <tr><td style="padding: 8px 0; font-weight: bold;">Email:</td><td><a href="mailto:${data.email}" style="color: #8537D8;">${data.email}</a></td></tr>
          ...
          <p style="font-size: 14px; color: #555; background: #fff; padding: 14px; border-radius: 8px; border-left: 4px solid #8537D8;">${data.motivo || '—'}</p>
      ...
      html = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background: #fff5fb; border-radius: 12px;">
          <h2 style="color: #F545B4; margin-bottom: 4px;">Nueva solicitud de cita</h2>
          ...
          <hr style="border: none; border-top: 1px solid #FFB5D5; margin: 20px 0;" />
          <p style="font-weight: bold; font-size: 14px; color: #333; margin-bottom: 8px;">Motivo de consulta:</p>
          <p style="font-size: 14px; color: #555; background: #fff; padding: 14px; border-radius: 8px; border-left: 4px solid #F545B4;">${data.motivo || '—'}</p>

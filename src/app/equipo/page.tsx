...
const equipo = [
  ...
  },
  {
    ...
    badgeCard: 'Neuropsicología Clínica',
...
function EspecialistaCard({ esp, reverse }: { esp: typeof equipo[0]; reverse: boolean }) {
  ...
  return (
    <section className={`py-16 lg:py-20 ${reverse ? 'bg-[#F6F2FF]' : 'bg-white'}`}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="rounded-3xl overflow-hidden bg-[#EDE5FF]" style={{ aspectRatio: esp.imgRatio ?? '3/2' }}>
              <img
                src={esp.img}
                alt={esp.imgAlt}

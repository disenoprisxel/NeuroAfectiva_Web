...
const steps = [
  { num: '1', bg: '#F545B4', title: 'Envías tu solicitud', desc: 'Completa el formulario con tus datos y preferencias.' },
  { num: '2', bg: '#8537D8', title: 'Te confirmamos en 24h', desc: 'Nuestro equipo revisará tu solicitud y confirmará el horario.' },
  { num: '3', bg: '#4585FF', title: '¡Nos vemos en la sesión!', desc: 'Presencial en Bogotá o virtual por videollamada.' },
]
...
const contactInfo = [
  ...
  {
    icon: Phone,
    iconColor: '#4585FF', iconBg: '#D5E2FF',
    label: 'WhatsApp',
    value: '319 351 7239',
  },
  {
    icon: Mail,
    iconColor: '#F545B4', iconBg: '#FFE0F5',
    label: 'Correo',
...
const reassure = [
  { icon: ShieldCheck, color: '#8537D8', text: 'Datos 100% confidenciales' },
  { icon: Timer, color: '#4585FF', text: 'Respuesta en menos de 24 horas' },
  { icon: CircleX, color: '#F545B4', text: 'Sin compromisos ni costos ocultos' },
]
...
export default function AgendarPage() {
  ...
  const inputClass = "w-full h-12 px-4 rounded-[10px] border-[1.5px] border-[#D1D5DB] bg-white text-sm text-[#0E234F] outline-none focus:border-[#8537D8] focus:ring-2 focus:ring-[#8537D8]/10 transition placeholder-[#9CA3AF]"
  ...
  return (
    <>
      ...
      >
        <span data-animate className="na-badge px-5 py-1.5 rounded-full text-[#8537D8] text-[13px] font-semibold" style={{ background: '#F0E6FF' }}>
          Atención especializada · Tu bienestar en manos expertas
        </span>
        <h1 data-animate data-delay="1" className="text-[36px] md:text-[52px] font-black text-[#0E234F]">Agenda tu cita</h1>
      ...
      <section className="w-full bg-white px-5 md:px-[120px] py-[60px]">
        <div className="flex flex-col md:flex-row gap-16 md:gap-20 w-full">
            ...
            {submitted ? (
              <div className="flex flex-col items-center gap-6 py-20 text-center">
                <div
                  ...
                  style={{ background: 'linear-gradient(135deg, #F545B4 0%, #8537D8 100%)' }}
                >
                  <CalendarCheck size={36} className="text-white" />
                </div>
                <h2 className="text-[#0E234F] text-2xl font-bold">¡Solicitud enviada!</h2>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-10">
                ...
                <div className="flex flex-col gap-5">
                  <div className="flex items-center gap-3">
                    <div className="w-7 h-7 rounded-[14px] flex items-center justify-center" style={{ background: '#F545B4' }}>
                      <span className="text-white text-[13px] font-extrabold">1</span>
                    </div>
                    <h2 className="text-[#0E234F] text-[18px] font-bold">Datos personales</h2>
                  </div>
                ...
                <div className="flex flex-col gap-5">
                  <div className="flex items-center gap-3">
                    <div className="w-7 h-7 rounded-[14px] flex items-center justify-center" style={{ background: '#8537D8' }}>
                      <span className="text-white text-[13px] font-extrabold">2</span>
                    </div>
                    <h2 className="text-[#0E234F] text-[18px] font-bold">Tipo de servicio</h2>
                  </div>
                          ...
                          return (
                            <button
                              ...
                              style={{
                                ...
                                border: `1.5px solid ${active ? '#8537D8' : '#E5E7EB'}`,
                              }}
                            >
                              <Icon size={18} style={{ color: active ? '#8537D8' : '#9CA3AF' }} />
                              <span className="text-[13px] font-semibold" style={{ color: active ? '#8537D8' : '#6B7280' }}>
                                {s.label}
                              </span>
                            </button>
                          )
                    ...
                    <div className="flex gap-3">
                      ...
                      <button
                        ...
                        style={{
                          ...
                          border: `2px solid ${form.modalidad === 'presencial' ? '#4585FF' : '#E5E7EB'}`,
                        }}
                      >
                        <div
                          className="w-9 h-9 rounded-[18px] flex items-center justify-center shrink-0"
                          style={{ background: form.modalidad === 'presencial' ? '#4585FF' : '#E5E7EB' }}
                        >
                          <MapPin size={18} style={{ color: '#fff' }} />
                        </div>
                        <div className="flex flex-col gap-0.5 text-left">
                          <span className="text-[14px] font-bold" style={{ color: form.modalidad === 'presencial' ? '#4585FF' : '#6B7280' }}>Presencial</span>
                      ...
                      <button
                        ...
                        style={{
                          ...
                          border: `2px solid ${form.modalidad === 'virtual' ? '#4585FF' : '#E5E7EB'}`,
                        }}
                      >
                        <div
                          className="w-9 h-9 rounded-[18px] flex items-center justify-center shrink-0"
                          style={{ background: form.modalidad === 'virtual' ? '#4585FF' : '#E5E7EB' }}
                        >
                          <Video size={18} style={{ color: '#fff' }} />
                        </div>
                        <div className="flex flex-col gap-0.5 text-left">
                          <span className="text-[14px] font-bold" style={{ color: form.modalidad === 'virtual' ? '#4585FF' : '#6B7280' }}>Virtual</span>
                          ...
                          return (
                            <button
                              ...
                              style={{
                                ...
                                border: `1.5px solid ${active ? '#F545B4' : '#D1D5DB'}`,
                                color: active ? '#F545B4' : '#9CA3AF',
                              }}
                            >
                              {h.label}
                            </button>
                ...
                <div className="flex flex-col gap-5">
                  <div className="flex items-center gap-3">
                    <div className="w-7 h-7 rounded-[14px] flex items-center justify-center" style={{ background: '#4585FF' }}>
                      <span className="text-white text-[13px] font-extrabold">3</span>
                    </div>
                    <h2 className="text-[#0E234F] text-[18px] font-bold">Cuéntanos más</h2>
                  </div>
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-[10px] border-[1.5px] border-[#D1D5DB] bg-white text-sm text-[#0E234F] outline-none focus:border-[#8537D8] focus:ring-2 focus:ring-[#8537D8]/10 transition placeholder-[#9CA3AF] resize-none leading-[1.6]"
                    />
                  </div>
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full h-12 pl-4 pr-10 rounded-[10px] border-[1.5px] border-[#D1D5DB] bg-white text-sm outline-none focus:border-[#8537D8] transition appearance-none text-[#9CA3AF]"
                      >
                  ...
                  <label className="flex items-start gap-3 cursor-pointer">
                    <div
                      ...
                      style={{ background: form.privacidad ? '#8537D8' : 'transparent', border: form.privacidad ? 'none' : '2px solid #D1D5DB' }}
          ...
          <div className="flex flex-col gap-6 w-full md:w-[380px] shrink-0">
            ...
            {/* Cómo funciona */}
            <div data-animate="right" className="flex flex-col gap-6 rounded-[20px] p-8" style={{ background: '#0E234F' }}>
              <div className="flex flex-col gap-1.5">
                <h3 className="text-white text-[18px] font-bold">¿Cómo funciona?</h3>
                <p className="text-[#9070CC] text-[14px]">Reservar tu cita es fácil y rápido.</p>
              </div>
              {steps.map(step => (
                <div key={step.num} className="flex gap-4 items-start">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <span className="text-[#9070CC] text-[13px] leading-[1.5]">{step.desc}</span>
                  </div>
                </div>
              ))}
            </div>
            ...
            >
              <h3 className="text-[#0E234F] text-[15px] font-bold">Información de contacto</h3>
                ...
                return (
                  <div key={item.label} className="flex items-start gap-3.5">
                    ...
                    <div className="flex flex-col gap-0.5">
                      ...
                      <span className="text-[#0E234F] text-[14px] font-semibold whitespace-pre-line leading-snug">{item.value}</span>
                    </div>
                  </div>
                )
              })}

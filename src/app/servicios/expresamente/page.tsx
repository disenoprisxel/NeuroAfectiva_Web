  ...
  return (
    <>
      ...
      <section className="w-full flex" style={{ height: '440px' }}>
        ...
        <div className="flex flex-col justify-center gap-4 px-5 md:px-[60px] py-[32px] w-full md:w-[560px] shrink-0 bg-white">
          ...
          <nav className="hidden md:flex items-center gap-2">
            <Link href="/" className="text-[#AAAAAA] text-xs hover:text-[#8537D8]">Inicio</Link>
            <ChevronRight size={11} className="text-[#CCCCCC]" />
            <Link href="/servicios" className="text-[#AAAAAA] text-xs hover:text-[#8537D8]">Servicios</Link>
            <ChevronRight size={11} className="text-[#CCCCCC]" />
            <span className="text-[#4585FF] text-xs font-semibold">ExpresaMente Creativa</span>
          </nav>

          {/* Tag */}
          <div data-animate className="inline-flex self-start items-center gap-2 px-4 py-1.5 rounded-full na-badge" style={{ background: '#E5EDFF' }}>
            <Palette size={13} style={{ color: '#4585FF' }} />
            <span className="text-[#3A75E8] text-[12px] font-semibold">Terapia a través de la expresión creativa</span>
          </div>

          {/* Title */}
          <h1
            data-animate data-delay="1"
            className="text-[40px] md:text-[52px] font-extrabold text-[#162845] leading-[0.95]"
          ...
          <div data-animate data-delay="3" className="flex items-center gap-3">
            ...
            <Link
              href="#modalidades"
              className="inline-flex items-center px-6 py-2.5 rounded-full text-sm font-semibold text-[#8537D8] bg-white"
      ...
      <div
        ...
        style={{ height: '56px', background: 'linear-gradient(90deg, #4585FF 0%, #8537D8 100%)' }}
      >
      ...
      <section className="w-full bg-white px-5 md:px-[120px] py-[80px] flex flex-col items-center gap-12">
        ...
        <div data-animate="scale" className="flex flex-col items-center gap-4 text-center w-full">
          <div className="flex items-center gap-4">
            <div className="flex-1 h-px" style={{ background: '#4585FF' }} />
            <span className="text-[#4585FF] text-[12px] font-extrabold tracking-[3px] uppercase">El programa</span>
            <div className="flex-1 h-px" style={{ background: '#4585FF' }} />
          </div>
          <h2 className="text-[26px] md:text-[42px] font-extrabold text-[#162845] leading-[1.2] max-w-[840px]">
        ...
        <div className="flex rounded-[20px] overflow-hidden w-full" style={{ background: '#F6F2FF' }}>
          {[
            { val: '60 min', label: 'por sesión', color: '#8537D8' },
            { val: '4', label: 'modalidades creativas', color: '#4585FF' },
            { val: 'Todas', label: 'las edades', color: '#F545B4' },
            { val: 'Online', label: 'y presencial', color: '#8537D8' },
          ].map((b, i) => (
      ...
      <section id="modalidades" className="w-full" style={{ background: '#FAFAFA' }}>
        <div data-animate className="px-5 md:px-[120px] py-[64px] pb-10 flex flex-col gap-2.5">
          <span className="text-[#8537D8] text-[11px] font-extrabold tracking-[3px] uppercase">Las modalidades</span>
          <h2 className="text-[26px] md:text-[38px] font-extrabold text-[#162845]">Cuatro caminos hacia la expresión</h2>
        </div>
              ...
              {mod.imgRight ? (
                <>
                  ...
                  >
                    ...
                    <h3 className="text-[#162845] text-[24px] md:text-[28px] font-extrabold">{mod.title}</h3>
      ...
      <section className="w-full">
        ...
        <div className="flex flex-col md:flex-row" style={{ minHeight: '560px' }}>
          ...
          >
            <span className="px-5 py-2 self-start rounded-full text-[#F545B4] text-[13px] font-semibold" style={{ background: '#2A1040' }}>
              ¿Para quién es?
            </span>
      ...
      <section
        ...
        style={{ background: 'linear-gradient(135deg, #F545B4 0%, #8537D8 50%, #4585FF 100%)', minHeight: '480px' }}
      >
        ...
        <div data-animate data-delay="1" className="flex flex-col md:flex-row items-center gap-5 w-full md:w-auto">
          <Link
            ...
            style={{ background: '#FFFFFF', color: '#8537D8' }}
          >
            Reservar sesión
          </Link>
          <Link

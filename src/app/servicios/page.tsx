  ...
  return (
    <section className="bg-white py-16 lg:py-20">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <span className="inline-flex items-center gap-2 bg-[#FFF0F9] text-[#FF4DA6] text-xs font-bold px-4 py-1.5 rounded-full mb-6 tracking-wide">
        ...
        <div className="flex flex-wrap justify-center gap-2">
          {categorias.map((c) => (
            <span
              key={c}
              className="bg-[#EEE8FF] text-[#7C4EC8] text-xs font-bold px-4 py-2 rounded-full hover:bg-[#7C4EC8] hover:text-white transition-colors cursor-pointer"
            >
              {c}
            </span>
          ))}
...
function ServiceCard({ service }: { service: typeof especialidades[0] }) {
  return (
    <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow group">
      {/* Image */}
      <div className="aspect-[16/9] bg-[#EEE8FF] overflow-hidden">
        <img
          src={service.img}
          alt={service.title}
      ...
      {/* Content */}
      <div className="p-6">
        <span className={`text-xs font-bold px-3 py-1 rounded-full ${service.badgeColor} mb-4 inline-block`}>
          {service.badge}
        </span>
        ...
        <Link
          href={service.href}
          className={`text-sm font-bold inline-flex items-center gap-1.5 ${service.linkColor} hover:gap-3 transition-all`}
        >
          Conocer más
...
function StatsBar() {
  return (
    <section className="bg-gradient-to-r from-[#182038] via-[#7C4EC8] to-[#8C5ED4] py-10">

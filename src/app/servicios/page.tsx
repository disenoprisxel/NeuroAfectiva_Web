  ...
  return (
    <section className="bg-white py-16 lg:py-20">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <span className="inline-flex items-center gap-2 bg-[#FFF0F9] text-[#fc66b5] text-xs font-bold px-4 py-1.5 rounded-full mb-6 tracking-wide">
        ...
        <div className="flex flex-wrap justify-center gap-2">
          {categorias.map((c) => (
            <span
              key={c}
              className="bg-[#F0EAFB] text-[#713ec1] text-xs font-bold px-4 py-2 rounded-full hover:bg-[#713ec1] hover:text-white transition-colors cursor-pointer"
            >
              {c}
            </span>
          ))}
...
function ServiceCard({ service }: { service: typeof especialidades[0] }) {
  return (
    <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow group">
      {/* Image */}
      <div className="aspect-[16/9] bg-[#F0EAFB] overflow-hidden">
        <img
          src={service.img}
          alt={service.title}

      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-2">
          {categorias.map((c) => (
            <span
              key={c}
              className="bg-[#EDE5FF] text-[#8537D8] text-xs font-bold px-4 py-2 rounded-full hover:bg-[#8537D8] hover:text-white transition-colors cursor-pointer"
            >
              {c}
            </span>
          ))}
...
function StatsBar() {
  return (
    <section className="bg-gradient-to-r from-[#0E234F] via-[#8537D8] to-[#9040DC] py-10">

    ...
    <>
        ...
        <div className="flex flex-col md:flex-row items-center gap-10 md:gap-20 w-full">
          ...
          <div className="flex flex-col gap-5 w-full md:w-[580px] shrink-0">
            ...
            <nav className="hidden md:flex items-center gap-1.5">
              <Link href="/" className="text-[#6B6B6B] text-xs hover:text-[#8537D8] transition-colors">Inicio</Link>
              <ChevronRight size={10} className="text-[#6B6B6B]" />
              <Link href="/servicios" className="text-[#6B6B6B] text-xs hover:text-[#8537D8] transition-colors">Servicios</Link>
              <ChevronRight size={10} className="text-[#6B6B6B]" />
              <span className="text-[#F545B4] text-xs">Neurohabilidades de Aprendizaje</span>
            </nav>
            ...
            <div data-animate data-delay="3">
              <Link
                ...
                style={{ background: 'linear-gradient(160deg, #F545B4 0%, #8537D8 100%)' }}
              >
                Agendar evaluación
              </Link>
            </div>
      ...
      <section className="w-full bg-[#F6F2FF] px-5 md:px-[120px] py-[40px] md:py-[80px]">
        <div className="flex flex-col md:flex-row gap-10 md:gap-20 w-full">
            ...
            <div data-animate data-delay="2" className="flex flex-col gap-3">
              {audienceItems.map((item) => (
                <div key={item} className="flex items-start gap-3">
                  <span className="mt-[6px] shrink-0 w-2 h-2 rounded-full bg-[#F545B4]" />
          ...
          <div data-animate="right" className="w-full md:w-[360px] shrink-0">
            <div className="flex flex-col gap-4 rounded-[20px] bg-[#8537D8] p-7">
      ...
      <section className="w-full bg-white px-5 md:px-[120px] py-[48px] md:py-[80px] flex flex-col items-center gap-10 md:gap-12">
        ...
        <div data-animate="scale" className="flex flex-col items-center gap-3 text-center">
          <p className="text-[#8537D8] text-[11px] md:text-xs font-bold tracking-[2px] uppercase">Beneficios</p>
      ...
      <section
        ...
        style={{ background: 'linear-gradient(135deg, #8537D8 0%, #F545B4 100%)' }}
      >

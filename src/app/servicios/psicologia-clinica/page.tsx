...
const specialties = [
  { icon: CloudRain, color: '#F545B4', borderColor: '#F545B430', label: 'Ansiedad y estrés' },
  { icon: Cloud, color: '#8537D8', borderColor: '#8537D830', label: 'Depresión' },
  { icon: Heart, color: '#4585FF', borderColor: '#4585FF30', label: 'Terapia de pareja' },
  { icon: Flame, color: '#F545B4', borderColor: '#F545B430', label: 'Trauma y PTSD' },
  { icon: Users, color: '#8537D8', borderColor: '#8537D830', label: 'Terapia familiar' },
  { icon: Leaf, color: '#4585FF', borderColor: '#4585FF30', label: 'Duelo y pérdida' },
  { icon: Scissors, color: '#F545B4', borderColor: '#F545B430', label: 'Trastornos alimentarios' },
  { icon: Moon, color: '#8537D8', borderColor: '#8537D830', label: 'Trastornos del sueño' },
  { icon: Zap, color: '#4585FF', borderColor: '#4585FF30', label: 'Crisis vitales y cambios' },
  { icon: Shield, color: '#F545B4', borderColor: '#F545B430', label: 'Baja autoestima' },
]
...
const processSteps = [
  ...
  {
    num: '04',
    gradient: 'linear-gradient(135deg, #F545B4 0%, #8537D8 100%)',
    lineColor: null,
    ...
    <>
      ...
      <section className="w-full relative flex items-center justify-center" style={{ height: '580px' }}>
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 px-5 md:px-[120px] py-[60px] text-center w-full">
          ...
          <nav className="hidden md:flex items-center gap-2">
            ...
            <ChevronRight size={11} className="text-white/31" />
            <span className="text-[#F545B4] text-xs font-semibold">Psicología Clínica</span>
          </nav>
          ...
          >
            <Heart size={15} style={{ color: '#F545B4' }} />
        ...
        <div className="flex flex-col md:flex-row items-center gap-16 md:gap-20 w-full">
          ...
          <div className="relative w-full md:w-[520px] h-[360px] md:h-[520px] shrink-0 rounded-[24px] overflow-hidden">
            ...
            >
              ...
              <span className="text-[#162845] text-[12px] font-semibold">Espacio seguro y confidencial</span>
            </div>
            {/* Stat overlay */}
            <div
              className="absolute bottom-11 right-0 flex flex-col gap-0.5 px-5 py-3.5 rounded-xl"
              style={{ background: '#F545B4' }}
            >
          ...
          <div className="flex flex-col gap-6 flex-1 min-w-0">
            ...
            <div className="flex gap-4 md:gap-6 mt-2">
              <div className="flex flex-col items-start gap-1 rounded-2xl px-5 md:px-6 py-5 flex-1" style={{ background: '#FFF0F9' }}>
                <span className="text-[22px] font-extrabold" style={{ color: '#F545B4' }}>50 min</span>
              ...
              <div className="flex flex-col items-start gap-1 rounded-2xl px-5 md:px-6 py-5 flex-1" style={{ background: '#EDE5FF' }}>
                <span className="text-[22px] font-extrabold" style={{ color: '#8537D8' }}>Online</span>
              ...
              <div className="flex flex-col items-start gap-1 rounded-2xl px-5 md:px-6 py-5 flex-1" style={{ background: '#E5EDFF' }}>
                <span className="text-[22px] font-extrabold" style={{ color: '#4585FF' }}>13+</span>
      ...
      <section className="w-full px-5 md:px-[120px] py-[80px] flex flex-col items-center gap-12" style={{ background: '#FFF0F9' }}>
        <div className="flex flex-col items-center gap-3 text-center">
          <span className="text-[#F545B4] text-[11px] md:text-xs font-extrabold tracking-[3px] uppercase">Áreas de atención</span>
      ...
      <section id="proceso" className="w-full bg-white px-5 md:px-[120px] py-[80px] flex flex-col gap-14">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div className="flex flex-col gap-2.5">
            <span className="text-[#F545B4] text-[11px] font-extrabold tracking-[3px] uppercase">El proceso terapéutico</span>
      ...
      <section
        ...
        style={{ minHeight: '340px', background: 'linear-gradient(135deg, #F545B4 0%, #8537D8 60%, #2D1040 100%)' }}
      >

    ...
    <section className="bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Left — copy */}
          <div>
            <span className="inline-block bg-[#EEE8FF] text-[#7C4EC8] text-xs font-bold px-4 py-1.5 rounded-full mb-6 tracking-wide">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#7C4EC8] mb-6">
              Neuropsicológico
            </h2>
            ...
            <div className="flex flex-wrap gap-3 mb-7">
              ...
              <Link
                href="/servicios"
                className="border-2 border-[#7C4EC8] text-[#7C4EC8] hover:bg-[#EEE8FF] font-bold px-7 py-3 rounded-full transition-colors text-sm"
              >
                Conocer servicios
              </Link>
            </div>
            ...
            <div className="flex items-center gap-2">
              <div className="flex gap-0.5">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} className="w-4 h-4 text-[#7C4EC8]" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
          ...
          <div className="relative overflow-hidden rounded-3xl">
            <div className="rounded-3xl overflow-hidden aspect-[4/3] bg-[#EEE8FF]">
              <img
                src="/images/hero.jpg"
    ...
    <section className="bg-[#F6F2FF] py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <span className="text-xs font-bold tracking-widest text-[#7C4EC8] uppercase">Nuestra Diferencia</span>
...
function StatsBar() {
  return (
    <section className="bg-gradient-to-r from-[#182038] via-[#7C4EC8] to-[#9d4edd] py-10">
...
const servicios = [
  ...
  {
    icon: Sparkles, iconColor: '#FF4DA6', iconBg: '#FF4DA6', cardBg: '#FFF0F9',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <span
            ...
            style={{ background: '#FFF0F9', color: '#FF4DA6' }}
          >
            Nuestros Servicios
          </span>
    ...
    <section className="bg-[#F6F2FF] py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          <span className="text-xs font-bold tracking-widest text-[#7C4EC8] uppercase">Nuestro Proceso</span>
...
function TestimoniosSection() {
  return (
    <section className="bg-white py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <span className="text-xs font-bold tracking-widest text-[#7C4EC8] uppercase">Testimonios</span>
          <h2 className="mt-2 text-3xl sm:text-4xl font-extrabold text-gray-900">Lo que dicen nuestras familias</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {testimonios.map((t) => (
            <div key={t.name} className="bg-[#F6F2FF] rounded-2xl p-8 flex flex-col">
              {/* Stars */}
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-[#E0D4F7] flex items-center justify-center text-[#7C4EC8] font-bold text-sm flex-shrink-0">
                  {t.name[0]}
                </div>
                <div>
    ...
    >
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-10">
          <Link
            href="/agendar"
            className="bg-white text-[#7C4EC8] hover:bg-gray-50 font-bold px-8 py-3 rounded-full transition-colors shadow-lg text-sm flex items-center gap-2"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">

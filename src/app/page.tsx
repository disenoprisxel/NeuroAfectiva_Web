    ...
    <section className="bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Left — copy */}
          <div>
            <span className="inline-block bg-[#EDE5FF] text-[#8537D8] text-xs font-bold px-4 py-1.5 rounded-full mb-6 tracking-wide">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#8537D8] mb-6">
              Neuropsicológico
            </h2>
            ...
            <div className="flex flex-wrap gap-3 mb-7">
              <Link
                href="/agendar"
                className="bg-[#8537D8] hover:bg-[#7530C5] text-white font-bold px-7 py-3 rounded-full transition-colors shadow-md text-sm"
              >
                Agendar mi cita
              </Link>
              <Link
                href="/servicios"
                className="border-2 border-[#8537D8] text-[#8537D8] hover:bg-[#EDE5FF] font-bold px-7 py-3 rounded-full transition-colors text-sm"
              >
                Conocer servicios
              </Link>
            </div>
            ...
            <div className="flex items-center gap-2">
              <div className="flex gap-0.5">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} className="w-4 h-4 text-[#8537D8]" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
    ...
    <section className="bg-[#F6F2FF] py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <span className="text-xs font-bold tracking-widest text-[#8537D8] uppercase">Nuestra Diferencia</span>
...
function StatsBar() {
  return (
    <section className="bg-gradient-to-r from-[#0E234F] via-[#8537D8] to-[#9d4edd] py-10">
...
const servicios = [
  ...
  {
    icon: Sparkles, iconColor: '#F545B4', iconBg: '#F545B4', cardBg: '#FFF0F9',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <span
            ...
            style={{ background: '#FFF0F9', color: '#F545B4' }}
          >
            Nuestros Servicios
          </span>
    ...
    <section className="bg-[#F6F2FF] py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          <span className="text-xs font-bold tracking-widest text-[#8537D8] uppercase">Nuestro Proceso</span>
...
function TestimoniosSection() {
  return (
    <section className="bg-white py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <span className="text-xs font-bold tracking-widest text-[#8537D8] uppercase">Testimonios</span>
          ...
          {testimonios.map((t) => (
            <div key={t.name} className="bg-[#F6F2FF] rounded-2xl p-8 flex flex-col">
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-[#E0D4F7] flex items-center justify-center text-[#8537D8] font-bold text-sm flex-shrink-0">
                  {t.name[0]}
                </div>
                <div>
